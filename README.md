...
```
cd existing_repo
git remote add origin https://git.epam.com/Yauheni_Tsiarletski/wdio-mocha-cucumber-simple-framework_wc20.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.epam.com/Yauheni_Tsiarletski/wdio-mocha-cucumber-simple-framework_wc20/-/settings/integrations)
...
# Steps and comands was completed
