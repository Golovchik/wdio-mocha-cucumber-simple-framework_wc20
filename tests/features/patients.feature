...
Feature: User Flow on 'Patients' page
   ...
   # Scenario: Change patient
    ...
    Scenario: Creating a new patient
        ...
        When I click on the element 'genderFemale' on page 'Patients' on component 'New Patient Modal'
        ...
        When  I click on the element 'save' on page 'Patients' on component 'New Patient Modal'
  ...
  #      Then I should see for patients 'Milka' into elements 'Name Link' on page 'Patients' on component 'Client Card'
  #      And I click on 'Name' on page 'Patients' in the 'ClientCard'
  #      Then I should see for patients 'Milka' into elements 'Name' on page 'Patients' on component 'Client Details'
  #      When I click on the patient with mobile number '(717) 555-4445' on the element 'Name Link' on page 'Patients' on component 'Client Card'